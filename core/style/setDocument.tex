...
keepaspectratio]{\fondPageDeGardeChemin}%
\vfill
}}}
...
\begin{tikzpicture}[overlay, remember picture]%
    ...
    \node[anchor=north east, minimum size=1in, inner xsep=5mm] at (current page.north east) {\includegraphics[scale=.2]{\ImageEnTetePages}};
\end{tikzpicture}
}
